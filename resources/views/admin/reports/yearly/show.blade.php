      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            @endif --}}
            <h1 class="m-0">Welcome To Yearly Report Session</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Yearly Report Session</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row text-center">
          <div class="col-lg-3 col-6">
              <h5>Total Balance USD and KHR</h3>
          </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                <a href="{{route('view.yearly.income')}}">
            ...
            <div class="col-lg-3 col-6">
                <a href="{{route('view.yearly.expense')}}">
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                        <h5 class="card-title">Expense Report</h5>
                        </div>
