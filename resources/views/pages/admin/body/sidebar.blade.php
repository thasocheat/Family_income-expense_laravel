...
<div class="dlabnav">
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow" href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" aria-expanded="false">
            ...
            <li><a class="has-arrow" href="{{ route('profile.show') }}" :active="request()->routeIs('profile.show')" aria-expanded="false">
            ...
            <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{ route('add.users') }}">Add User</a></li>
                    <li><a href="edit-professor.html">Edit User</a></li>
                </ul>
            </li>
