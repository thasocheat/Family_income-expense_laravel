...
class ReportsController extends Controller
{
    ...
    public function view_weekly_index(){
        return view('admin.reports.weekly.show');
    }
    ...
    public function get_weekly_expense(){
        ...
        if($filteredExpenses->isEmpty()){
            ...
            foreach($groupedExpenses as $incomeCategoryId => $expenses){
                    $incomeCategory = $expenses->first()->income_category->name;
                    $expensesSummary[$incomeCategory] = [
                        'name' => $incomeCategory,
